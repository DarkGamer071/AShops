...
public enum ASMessage implements AMessage {
	CMD_ASSHOP(Level.NONE), CMD_AMENU(Level.NONE), CMD_ASHOP(Level.NONE), CMD_AREMOVE(
			Level.NONE), CMD_ATOGGLE(Level.NONE), CMD_ASELL(Level.NONE), CMD_ABUY(
			Level.NONE), CMD_AREPAIR(Level.NONE), CMD_ASAVE(Level.NONE), CMD_ALOAD(
			Level.NONE), CMD_ACLEAR(Level.NONE), CMD_ASHOPS(Level.NONE), CMD_ARELOAD(
			Level.NONE), NOT_PLAYER(Level.FAILURE), SELECT_CHEST(Level.INFO), NO_MONEY(
			Level.FAILURE) /* int */, LIMIT(Level.FAILURE), NO_PERMISSION(
			Level.FAILURE), INVALID_PLAYER(Level.FAILURE), ABORTED(
			Level.FAILURE), CREATED(Level.SUCCESS), ALREADY_SHOP(Level.FAILURE), ERROR(
			Level.ERROR), SHOP_NEIGHBOUR(Level.FAILURE), DOUBLE_CHEST(
			...
			Level.NONE), CHEST_NEIGHBOUR(Level.FAILURE), OP_CREATE_OWN_SHOP(
			Level.NONE), OP_REMOVE_SHOP(Level.NONE), OP_BUY(Level.NONE), OP_SELL(
			Level.NONE), OP_TOGGLE(Level.NONE), OP_CREATE_OTHERS_SHOP(Level.NONE), OP_REPAIR(
			Level.NONE), OP_CREATE_SERVER_SHOP(Level.NONE), OP_RELOAD(
			Level.NONE), OP_SAVE(Level.NONE), OP_LOAD(Level.NONE), OP_CLEAR_ALL(
			Level.NONE), OP_CLEAR_PLAYER_SHOPS(Level.NONE), OP_CLEAR_SERVER_SHOPS(
			Level.NONE), OP_CLEAR_PLAYER_S_SHOPS(Level.NONE);
